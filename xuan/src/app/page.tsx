...
const features = [
  ...
  },
  {
    icon: TrendingUp,
    color: "text-[#A78BFA]",
    glow: "group-hover:shadow-[0_0_20px_-4px_rgba(167,139,250,0.3)]",
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-[1fr_420px] gap-16 items-center">
          ...
          <div className="animate-slide-up">
            ...
            <h1 className="font-display font-bold text-[2.75rem] sm:text-[3.5rem] leading-[1.08] tracking-tight mb-6">
              <span className="text-white">Find properties that will</span>
              <br />
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <button className="btn-ghost btn-lg gap-2">
            ...
            <div className="card-glass border-accent/15 glow-accent p-0 overflow-hidden">
              ...
              <div className="px-5 py-4 space-y-3 border-b border-white/[0.06]">
                {[
                  ...
                  { label: "Cap Rate", value: "7.2%", tag: "strong", tagColor: "text-emerald-light" },
                  { label: "Cash Flow", value: "+$470/mo", positive: true },
                  { label: "DSCR", value: "1.35x", tag: "good", tagColor: "text-emerald-light" },
                ].map((m) => (
                  <div key={m.label} className="flex items-center justify-between">
                    <span className="text-xs text-content-tertiary">{m.label}</span>
                    <div className="flex items-center gap-2">
                      <span className={`text-sm font-mono font-semibold ${m.positive ? "text-emerald-light" : "text-white"}`}>
                        {m.value}
                      </span>
                      {m.tag && (
              ...
              <div className="px-5 py-4 space-y-3">
                ...
                <div className="h-1.5 bg-surface-muted rounded-full overflow-hidden">
                  <div
                    className="h-full rounded-full bg-gradient-to-r from-accent to-[#A78BFA] transition-all"
                    style={{ width: "87%" }}
                  />
                </div>
      ...
      <section className="border-y border-white/[0.06] bg-gradient-to-b from-surface-secondary to-surface">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4">
          {[
            ...
            <div
              key={m.label}
              className={`px-6 py-8 text-center ${i < 3 ? "border-r border-white/[0.06]" : ""} ${i < 2 ? "border-b md:border-b-0 border-white/[0.06]" : ""}`}
            >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-xl mb-16">
            ...
            <p className="text-content-secondary leading-relaxed">
              Institutional-grade analytics, available to every investor.
            </p>
          </div>
      ...
      <section className="py-28 px-6 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl font-bold text-white tracking-tight mb-3">
              Built for investors who read the numbers
            </h2>
            <p className="text-content-secondary max-w-lg mx-auto">
              Every data point sourced, every metric benchmarked, every risk surfaced.
            </p>
          </div>
          ...
          <div className="card-glass glow-accent border-accent/10 p-0 overflow-hidden max-w-4xl mx-auto">
            ...
            <div className="px-6 py-4 border-b border-white/[0.06]">
              ...
              <div className="grid grid-cols-3 gap-6">
                <div>
                  <div className="text-xs text-content-tertiary mb-0.5">30yr Fixed</div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-xl font-mono font-bold text-white">6.95%</span>
                    <span className="text-xs font-mono text-emerald-light">&darr;0.08</span>
                  </div>
                </div>
                <div>
                  <div className="text-xs text-content-tertiary mb-0.5">Fed Funds</div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-xl font-mono font-bold text-white">4.75%</span>
                  </div>
                </div>
                <div>
                  <div className="text-xs text-content-tertiary mb-0.5">Spread</div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-xl font-mono font-bold text-white">2.20%</span>
                    <span className="badge-emerald text-[10px]">NORMAL</span>
                  </div>
                </div>
              </div>
            </div>

            {/* Market Rankings + Portfolio side-by-side */}
            <div className="grid md:grid-cols-2 divide-x divide-white/[0.06]">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex gap-0.5">
                          {Array.from({ length: 5 }).map((_, j) => (
                            <div
                              key={j}
                              className={`w-1 h-3 rounded-sm ${j < m.bars ? "bg-accent-light" : "bg-surface-muted"}`}
                            />
                          ))}
                        </div>
              ...
              <div className="px-6 py-4">
                ...
                <div className="space-y-2.5">
                  {[
                    { label: "Total Value", value: "$1.06M", trend: null },
                    { label: "Monthly CF", value: "+$1,140", trend: "up" },
                    { label: "Avg Cap Rate", value: "6.5%", trend: null },
                  ].map((p) => (
                    <div key={p.label} className="flex items-center justify-between">
                      <span className="text-sm text-content-secondary">{p.label}</span>
                      <span className={`text-sm font-mono font-bold ${p.trend === "up" ? "text-emerald-light" : "text-white"}`}>
                        {p.value}
                      </span>
                    </div>
                  ))}
      ...
      <section className="py-28 px-6 border-t border-white/[0.06] relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
            Stop guessing.{" "}
            <span className="text-gradient">Start investing with conviction.</span>
          </h2>
          <p className="text-content-secondary leading-relaxed mb-8 text-lg">
            Join investors analyzing markets across 50 states.
          </p>
          <Link href="/signup" className="btn-primary btn-lg group">
            Get Started Free
