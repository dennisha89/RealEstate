...
export const metadata: Metadata = {
  title: "Terms of Service — Xuan",
  description: "Terms and conditions governing your use of the Xuan real estate intelligence platform.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12 text-sm text-content-secondary leading-relaxed">
            ...
            <section>
              ...
              <p className="mb-4">
                These Terms of Service (&ldquo;Terms&rdquo;) constitute a legally binding agreement between you (&ldquo;User,&rdquo; &ldquo;you,&rdquo; or &ldquo;your&rdquo;) and Xuan Intelligence, Inc. (&ldquo;Xuan,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) governing your access to and use of the Xuan real estate intelligence platform, including all associated websites, applications, APIs, and services (collectively, the &ldquo;Service&rdquo;).
              </p>
              <p>
            ...
            <section>
              ...
              <p className="mb-4">
                You are solely responsible for maintaining the confidentiality of your account credentials, including your password. You agree to immediately notify us of any unauthorized use of your account or any other breach of security. Xuan shall not be liable for any loss or damage arising from your failure to protect your account credentials. You are responsible for all activities that occur under your account, whether or not authorized by you.
              </p>
            ...
            <section>
              ...
              <h3 className="text-base font-semibold text-content-primary mb-2">5.1 Xuan&rsquo;s Intellectual Property</h3>
              <p className="mb-4">
                The Service, including all software, algorithms, analytical engines, scoring methodologies, proprietary models, user interface design, visual design, trademarks, logos (including the &ldquo;&#x7384;&rdquo; mark and &ldquo;XUAN&rdquo; word mark), documentation, and all content created by Xuan, is and shall remain the exclusive property of Xuan Intelligence, Inc. and its licensors. The Service is protected by copyright, trademark, trade secret, and other intellectual property laws. Nothing in these Terms grants you any right, title, or interest in the Service except for the limited right to use it in accordance with these Terms.
              </p>

              <h3 className="text-base font-semibold text-content-primary mb-2">5.2 Your Data</h3>
              <p className="mb-4">
                You retain all ownership rights to the portfolio data, property information, financial inputs, and other content that you submit to the Service (&ldquo;User Data&rdquo;). By submitting User Data, you grant Xuan a limited, non-exclusive, worldwide license to use, process, and store your User Data solely for the purpose of providing and improving the Service. This license terminates when you delete your User Data or close your account, except with respect to data that has already been incorporated into anonymized, aggregate datasets.
              </p>

              <h3 className="text-base font-semibold text-content-primary mb-2">5.3 Feedback</h3>
              <p>
                If you provide any suggestions, ideas, feedback, or recommendations regarding the Service (&ldquo;Feedback&rdquo;), you hereby assign to Xuan all rights in such Feedback and agree that Xuan may use and incorporate such Feedback without restriction, attribution, or compensation to you.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="card border-rose/20 p-5">
                ...
                <div className="space-y-3 text-content-secondary">
                  <p>
                    <span className="text-content-primary font-semibold">Xuan provides data and analysis, NOT investment advice.</span> The Service is a data analytics and research platform designed to help users organize, analyze, and visualize real estate market data. Nothing contained in the Service constitutes an offer, solicitation, or recommendation to buy, sell, hold, or otherwise transact in any real property or security.
                  </p>
                  <p>
                    <span className="text-content-primary font-semibold">We are not registered investment advisors.</span> Xuan Intelligence, Inc. is not registered as an investment adviser with the U.S. Securities and Exchange Commission (SEC) or with any state securities regulatory authority. We do not provide personalized investment advice, financial planning services, or fiduciary services.
                  </p>
                  <p>
                  ...
                  <p>
                    For additional information, please review our full <Link href="/disclaimer" className="text-accent-light hover:text-white transition-colors underline underline-offset-2">Investment Disclaimer</Link>.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL XUAN INTELLIGENCE, INC., ITS DIRECTORS, OFFICERS, EMPLOYEES, AGENTS, AFFILIATES, SUCCESSORS, OR ASSIGNS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, OR EXEMPLARY DAMAGES, INCLUDING BUT NOT LIMITED TO DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE, DATA, INVESTMENT LOSSES, OR OTHER INTANGIBLE LOSSES, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF OR INABILITY TO USE THE SERVICE, REGARDLESS OF THE THEORY OF LIABILITY (CONTRACT, TORT, STRICT LIABILITY, OR OTHERWISE), EVEN IF XUAN HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
              </p>
              <p className="mb-4">
                IN NO EVENT SHALL XUAN&rsquo;S TOTAL AGGREGATE LIABILITY TO YOU FOR ALL CLAIMS ARISING OUT OF OR RELATING TO THESE TERMS OR THE SERVICE EXCEED THE GREATER OF (A) THE AMOUNTS YOU HAVE PAID TO XUAN IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM, OR (B) ONE HUNDRED U.S. DOLLARS ($100.00).
              </p>
              <p>
                SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES, SO SOME OF THE ABOVE LIMITATIONS MAY NOT APPLY TO YOU. IN SUCH JURISDICTIONS, XUAN&rsquo;S LIABILITY SHALL BE LIMITED TO THE MAXIMUM EXTENT PERMITTED BY LAW.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Xuan makes no warranty or representation regarding the accuracy, completeness, timeliness, or reliability of any data, analysis, or content provided through the Service. The Service is provided on an &ldquo;as is&rdquo; and &ldquo;as available&rdquo; basis without warranties of any kind, either express or implied.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                Xuan offers a free tier that provides limited access to the Service, including a limited number of property analyses per month. The free tier is subject to usage limits and feature restrictions as described on our pricing page. We reserve the right to modify the scope of the free tier at any time.
              </p>
            ...
            <section>
              ...
              <p>
                Upon account deletion, we will delete your personal data in accordance with our <Link href="/privacy" className="text-accent-light hover:text-white transition-colors underline underline-offset-2">Privacy Policy</Link>, subject to any legal retention obligations.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Before initiating any formal legal proceedings, you agree to first attempt to resolve any dispute informally by contacting us at <a href="mailto:legal@xuan.ai" className="text-accent-light hover:text-white transition-colors underline underline-offset-2">legal@xuan.ai</a>. We will attempt to resolve the dispute through good-faith negotiation within 30 days. If the dispute is not resolved within 30 days, either party may proceed with formal legal action as described above.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                These Terms, together with our Privacy Policy and Investment Disclaimer, constitute the entire agreement between you and Xuan regarding the Service and supersede all prior agreements, understandings, and communications, whether oral or written.
              </p>
              ...
              <p className="mb-4">
                The failure of Xuan to enforce any right or provision of these Terms shall not constitute a waiver of such right or provision. Any waiver of any provision of these Terms must be in writing and signed by Xuan.
              </p>

              <h3 className="text-base font-semibold text-content-primary mb-2">12.4 Assignment</h3>
              <p>
                You may not assign or transfer these Terms or your rights under these Terms without our prior written consent. Xuan may assign these Terms without restriction, including in connection with a merger, acquisition, reorganization, or sale of assets.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="card p-5 space-y-2">
                ...
                <p>General inquiries: <a href="mailto:hello@xuan.ai" className="text-accent-light hover:text-white transition-colors underline underline-offset-2">hello@xuan.ai</a></p>
              </div>
            </section>
