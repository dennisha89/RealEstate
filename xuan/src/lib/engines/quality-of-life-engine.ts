...
import { buildTrendMetric } from "./demographic-engine";
...
export function analyzeQualityOfLife(data: RawQualityOfLifeData): QualityOfLife {
  ...
  return {
    ...
    crimeRate: {
      violentPer1000: buildTrendMetric(
        data.crime.violentPer1000.current,
        data.crime.violentPer1000.oneYearAgo,
        data.crime.violentPer1000.threeYearAgo,
        data.crime.violentPer1000.fiveYearAgo
      ),
      propertyPer1000: buildTrendMetric(
        data.crime.propertyPer1000.current,
        data.crime.propertyPer1000.oneYearAgo,
        data.crime.propertyPer1000.threeYearAgo,
        data.crime.propertyPer1000.fiveYearAgo
      ),
