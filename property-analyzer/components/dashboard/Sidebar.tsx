...
const navItems = [
  ...
  { href: "/deals", label: "Deal Scanner", icon: DollarSign },
        ...
        <div className="flex items-center gap-3 overflow-hidden">
          ...
          {!collapsed && (
            <div className="animate-fade-in">
              <p className="text-sm font-bold text-gray-100">RealEstate</p>
            ...
            >
              <Icon
                className={`h-5 w-5 flex-shrink-0 ${
                  active ? "text-money-400" : "text-gray-500 group-hover:text-gray-300"
                }`}
              />
