  ...
  return (
    <div className="min-h-screen bg-surface text-content-primary overflow-x-hidden">
      ...
      <section className="relative pt-32 md:pt-40 pb-20 px-6 overflow-hidden">
        ...
        <div className="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full bg-gold/[0.06] blur-[150px]" />
        <div className="relative max-w-3xl mx-auto">
          <p className="text-gold-light text-xs font-semibold tracking-[0.12em] uppercase mb-4">Our Mission</p>
          ...
          <p className="text-content-secondary text-lg leading-relaxed">
            ...
            We built LootVue to close the gap between those who have information and those who don&apos;t.
          </p>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-3 gap-4 mt-10">
            {STATS.map((s) => (
              <div key={s.label} className="card text-center">
                <s.icon className="w-5 h-5 text-gold-light mx-auto mb-3" />
      ...
      <section className="py-20 px-6 border-t border-white/[0.06]">
        <div className="max-w-3xl mx-auto">
          <p className="text-gold-light text-xs font-semibold tracking-[0.12em] uppercase mb-3">Our Data Sources</p>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {SOURCES.map((s) => (
              <div key={s.tag} className="card group hover:border-gold/20 transition-all">
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-sm font-mono font-bold text-gold-light">{s.tag}</span>
      ...
      <section className="py-20 px-6 border-t border-white/[0.06] bg-surface-secondary/20">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-5 text-content-secondary leading-relaxed mb-10">
            ...
            <p>LootVue exists because we got tired of the gap. We built the platform we wished existed when we were making our own investment decisions with incomplete data and borrowed spreadsheets.</p>
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="card">
