...
function agreeLabel(v: boolean | null) {
  if (v === true) return <span className="badge-gold">AGREE</span>;
                ...
                <tr key={m.market} className="hover:bg-white/[0.02] transition-colors group">
                  <td className="py-3 pr-4">
                    <Link href={`/dashboard/markets/${m.slug}`}
                      className="flex items-center gap-1.5 font-medium text-content-primary group-hover:text-gold-light transition-colors">
      ...
      <section className="card-gold">
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 rounded-lg bg-gold-muted flex items-center justify-center shrink-0">
            <GitMerge className="w-5 h-5 text-gold-light" />
          </div>
          <div className="flex-1">
            <div className="flex items-baseline gap-2 mb-1">
              ...
              <span className="font-mono text-lg font-bold text-gold-light">{CONTRARIAN_SCORE}%</span>
            </div>
