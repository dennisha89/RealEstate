...
export const metadata: Metadata = {
  title: "Privacy Policy — LootVue",
  description: "How LootVue collects, uses, and protects your personal information.",
};
      ...
      <main className="pt-32 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12 text-sm text-content-secondary leading-relaxed">
            ...
            <p>
              LootVue Inc. (&ldquo;LootVue,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) operates the LootVue real estate intelligence platform (the &ldquo;Service&rdquo;). This Privacy Policy describes how we collect, use, disclose, and protect your personal information when you access or use our Service, including our website, applications, and related services.
            </p>
            <p>
            ...
            <section>
              ...
              <p className="mt-4">
                To exercise any of these rights, contact us at <a href="mailto:legal@lootvue.com" className="text-gold-light hover:text-white transition-colors underline underline-offset-2">legal@lootvue.com</a>. We will respond to verified requests within 30 days.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">
                To submit a CCPA request, contact us at <a href="mailto:legal@lootvue.com" className="text-gold-light hover:text-white transition-colors underline underline-offset-2">legal@lootvue.com</a>. We will verify your identity before processing your request. You may also designate an authorized agent to make a request on your behalf.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="card p-5 space-y-2">
                ...
                <p>Privacy inquiries: <a href="mailto:privacy@lootvue.com" className="text-gold-light hover:text-white transition-colors underline underline-offset-2">privacy@lootvue.com</a></p>
              </div>
